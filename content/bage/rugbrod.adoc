...
IMPORTANT: Tag 300 g surdej fra og sæt i køleskab.

Dejen hældes op i en smurt (vi bruger smør
) form (vores er 18 cm lang og 10 høj så vi får et stort stykke rugbrød).
